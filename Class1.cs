...
namespace PrNumber5
{
    internal class SubClass
    {
        ...
        static string[] razmer = new string[5] { "  Малый - 300;", "  Средний - 450;", "  Большой- 600;", "  Подарочный - 900;", "  Свадебный - 1200;" };
        static string[] vkusy = new string[5] { "  Клубничный - 300;", "  Малиновый - 400;", "  Шоколадный - 200;", "  Ореховый - 600;", "  Сметанный - 100;" };
        static string[] Kolichestvo_Korgey = new string[5] { "  Один - 100;", "  Два - 200;", "  Три - 300;", "  Четыре - 400;", "  Пять - 500;" };
        static string[] glazur = new string[5] { "  Шоколад - 200;", "  Крем - 200;", "  Бизе - 300;", "  Драже - 150;", "  Ягоды - 400;" };
        static string[] ukrashenie = new string[5] { "  Праздничный - 500;", "  Глазурный - 300;", "  Сироп - 200;", "  Карамель - 150;", "  Шоколад - 200;" };
                            ...
                            case ConsoleKey.Enter:
                                switch (position)
                                {
                                    ...
                                    case 9:
                                        ...
                                        File.AppendAllText("D:\\ConsoleApp22\\ConsoleApp22", $"Время заказа {date}\r\n Цена: {x}\r\n Состав заказа: {y}\r\n");
                                        x = 0;
                                        y = "";
                                        SubClass.x = 0;
                                        SubClass.y = "";
